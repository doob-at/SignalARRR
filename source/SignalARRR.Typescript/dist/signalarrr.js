...
exports.HARRRConnection = void 0;
const signalR = require("@microsoft/signalr");
const client_request_message_1 = require("./client-request-message");
const client_response_message_1 = require("./client-response-message");
class HARRRConnection {
    constructor(hubConnection) {
        ...
        this._accessTokenFactory = (_b = (_a = this._hubConnection.connection) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.accessTokenFactory;
        this._hubConnection.on("ChallengeAuthentication", (request) => {
            const msg = new client_response_message_1.ClientResponseMessage(request.Id);
    ...
    invoke(methodName, ...args) {
        var msg = new client_request_message_1.ClientRequestMessage(methodName, ...args).WithAuthorization(this._accessTokenFactory);
    ...
    static create(hubConnection) {
        if (hubConnection instanceof Function) {
            var hubConnectionBuilder = new signalR.HubConnectionBuilder();
            hubConnection(hubConnectionBuilder);
            return new HARRRConnection(hubConnectionBuilder.build());
        }
        return new HARRRConnection(hubConnection);
    }
...
exports.HARRRConnection = HARRRConnection;
